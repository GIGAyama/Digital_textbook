# ✅ GIGA Standard v4 監査：教材プリントメーカー（旧称：デジタル教科書メーカー）

> 表示名を「教材プリントメーカー」に改めた。**学校教育法第34条第2項に定める「学習者用デジタル教科書」ではない**ことを、
> `index.html` の `<title>`・manifest・アプリのヘッダー・README に明記してある。
> 以下の記述のうち「デジタル教科書メーカー」は改名前の名前として読むこと。
